...
const HomeHeader = () => {
  return (
    <header className="w-full flex items-center justify-between py-4">
        ...
        <div className="focus-within:border-1 focus-within:border-dark-blue w-[235px] h-[36px] rounded-2xl bg-[#F8F8F8] flex items-center justify-between overflow-hidden">
