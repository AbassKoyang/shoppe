            ...
            <CarouselContent className='rounded-lg'>
               <CarouselItem className='w-full h-[140px] bg-transparent rounded-lg'>
                <div className="size-full rounded-lg overflow-hidden">
                    <div className="size-full p-3 flex items-center justify-between relative bg-dark-blue object-contain">
                        <div className="w-[60%] z-20 flex flex-col items-start justify-between h-full">
                        <p className="text-[24px] text-white font-raleway font-bold max-w-full leading-6">Discover the Hottest Deals</p>
                        <p className="text-[10px] font-nunito-sans font-normal text-white mt-1.5 mx-w-full">Step up your style game — find trending shoes, bags, and outfits at student-friendly prices.</p>
                        ...
                        <img className='z-20 w-[300px]' src="/assets/images/banner-shoe.png" alt="Shoe" />
                        {/* bubbles */}
