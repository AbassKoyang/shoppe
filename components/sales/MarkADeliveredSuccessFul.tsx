...
const MarkAsDeliveredSuccesfulModal = ({open, redirect, closeModal} : {open: boolean; redirect: () => void; closeModal: () => void;}) => {
  return (
    <motion.div className={`${open ? 'flex' : 'hidden'} w-[100vw] h-dvh fixed top-0 left-0 items-center justify-center bg-transparent z-200`}>
        ...
        className="w-full max-w-xs bg-[#F8FAFF] rounded-xl p-6 z-20 relative shadow-md">
            ...
            <div className="w-full flex flex-col items-center">
                <h3 className='text-black font-raleway font-semibold text-xl mt-5 text-center max-w-[250px]'>Order Marked as Delivered!</h3>
                <p className='text-black font-nunito-sans font-semibold text-[10px] mt-2 text-center max-w-[200px]'>The buyer will be notified and payment will be released to the you when they receive the item.</p>
            </div>
...
export default MarkAsDeliveredSuccesfulModal;