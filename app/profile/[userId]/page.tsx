  ...
  return (
    <section className="w-full mt-2 relative overflow-x-hidden mb-[300px]">
        ...
        <div className="w-full mt-3">
          ...
          <h3 className="text-[21px] font-raleway font-bold text-[#202020] mt-3">Recently viewed</h3>
        ...
        <div className="w-full mt-6">
            <h3 className="text-[21px] font-raleway font-bold text-[#202020]">Listed Items</h3>
