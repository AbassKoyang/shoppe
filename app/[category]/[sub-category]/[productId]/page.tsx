...
const page = () => {
  ...
  return (
    <section className="w-full">
      ...
      <div className="px-4 [@media(min-width:375px)]:px-6">
        ...
        <div className="w-full flex flex-wrap justify-between items-start">
          <div className="w-[50%] flex flex-col items-start">
            ...
            <span className="text-[14px] text-black font-raleway font-medium bg-[#FFEBEB] py-0.5 px-3 rounded-[4px] mt-1">{product?.material}</span>
          </div>
          <div className="w-[50%] flex flex-col items-start">
          ...
          <div className="w-[50%] flex flex-col items-start">
            ...
            <span className="text-[14px] text-black font-raleway font-medium bg-[#FFEBEB] py-0.5 px-3 rounded-[4px] mt-1">{product?.condition}</span>
          </div>
          <div className="w-[50%] flex flex-col items-start">
