...
type EditBankFormType = {
    open: boolean;
    closeModal: () => void;
}


const EditBankForm = ({open, closeModal} : EditBankFormType) => {
    const {user} = useAuth();
    ...
    const form = useForm<z.infer<typeof formSchema>>({
        ...
        defaultValues: {
          ...
          accountNumber: user?.bankDetails?.accountNumber || 'kjhihihi',
    ...
    const AddBankMutation = useMutation({
        ...
        onSuccess: (data) => {
            ...
            router.push('/settings/bank-details');
        }
    });
        ...
        <motion.div 
            ...
            className={`h-dvh w-[100vw] fixed top-0 left-0 bg-transparent flex flex-col justify-end`}>
                ...
                <div className='z-20 w-full bg-[#F8FAFF] rounded-t-2xl py-6'>
                    <h3 className='text-[22px] font-raleway font-bold mb-6 ml-6'>Edit Bank Account</h3
                    >
                        <Form {...form}>
                            <form
                            ...
                            >
                                ...
                                render={({ field }) => (
                                    ...
                                    <Select onValueChange={field.onChange} value={field.value}>
                                        ...
                                        <SelectValue placeholder={loading ? 'Loading banks...' : user?.bankDetails?.bankName} />
                                        </SelectTrigger>
